...
export interface ERC20BasicInterface extends utils.Interface {
  functions: {
    ...
    "unitsOneWeiCanBuy()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "unitsOneWeiCanBuy",
    values?: undefined
  ): string;
...
export interface ERC20Basic extends BaseContract {
  ...
  functions: {
    ...
    unitsOneWeiCanBuy(overrides?: CallOverrides): Promise<[BigNumber]>;
  };
  ...
  populateTransaction: {
    ...
    unitsOneWeiCanBuy(overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
